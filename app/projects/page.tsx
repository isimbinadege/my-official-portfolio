...
function Projects() {
  const projects = [
    { title: 'StorySphere', desc: 'StorySphere: Connecting storytellers and readers through shared stories.', tags: ['Next.js', 'Supabase'] },
    { title: 'Echoes of Rwanda', desc: 'A platform to explore and plan trips across Rwanda.', tags: ['Next.js', 'Node', 'MongoDB'] },
    { title: 'Movix', desc: 'Search, discover, and dive into your favorite films', tags: ['React '] },
    { title: 'Freelance Dashboard', desc: 'A type-safe Freelance Management Dashboard to track clients, projects, and payments efficiently.', tags: ['Next.js'] },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-10">
            {projects.map((project, index) => (
              <div key={index} className="group bg-stone-900/40 backdrop-blur-sm border border-stone-800/30 overflow-hidden hover:border-amber-800/50 transition-all duration-500 animate-fade-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="h-48 bg-gradient-to-br from-amber-900/20 to-stone-900/40 relative overflow-hidden">
                ...
                <div className="p-8">
                  ...
                  <div className="flex gap-6">
                    <a href="https://storysphere-bo7p.vercel.app/" className="text-amber-600 hover:text-amber-500 text-sm font-light tracking-wider transition-all duration-300 flex items-center gap-2">
                      Live Demo <span>↗</span>
                    </a>
                    <a href="https://github.com/isimbinadege/storysphere" className="text-stone-400 hover:text-amber-600 text-sm font-light tracking-wider transition-all duration-300 flex items-center gap-2">
                      GitHub <span>→</span>
                    </a>
                  </div>
                </div>
