            ...
            <div className="space-y-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="bg-stone-900/40 backdrop-blur-sm border border-stone-800/30 p-10">
                ...
                <div className="flex gap-4">
                  ...
                  <a href="https://twitter.com/isimbinadege" target="_blank" rel="noopener noreferrer" className="w-14 h-14 flex items-center justify-center border border-stone-800/40 hover:border-amber-700 transition-all duration-500">
